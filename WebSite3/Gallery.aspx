...
<div class="alc"><a href="Teachers.html"></a></div>
    ...
    <div class="col-2">
     ...
     <h2>CLASS PICTURE GALLERIES</h2>
  <h2>    </h2>

   <form id="form1" runat="server">
   <asp:Panel ID="Panel1" runat="server" Width="700px"></asp:Panel>
    </form>
    </div>
    <div class="col-3">
      <h2>Latest Tweets</h2>
...
<!-- END PAGE SOURCE<div align=center>This template  downloaded form <a href='http://all-free-download.com/free-website-templates/'>free website templates</a></div> -->
</body>
</html>
